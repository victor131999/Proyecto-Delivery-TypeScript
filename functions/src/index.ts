...
import { routesCustomer,routesMotorized,routesLocal,routesProduct, routesCharge,routesAuth, routesFood ,routesReservationFood,routesReportFood,routesDrink,routesCombo} from './router';
...
//------------------------------------
routesFood(server);
routesReservationFood(server);
routesReportFood(server);
routesDrink(server);
routesCombo(server);
//------------------------------------
